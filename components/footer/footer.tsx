...
export const Footer = () => (
  <footer className="relative flex h-full w-full items-center justify-evenly gap-y-5 overflow-hidden bg-ellipse from-regalblue-700 from-25% to-regalblue-900 to-60% py-4 text-white max-md:flex-col">
    <Link
