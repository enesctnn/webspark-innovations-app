...
export const HoverCardContent = ({
  ...
  <article
    className="absolute top-0 z-40 grid h-full w-full items-stretch justify-center divide-x divide-pastelblue overflow-hidden text-center"
  ...
  >
    {content.map(({ description, title }, index) => {
      ...
      return (
        <section
          key={title}
          className="group mx-auto cursor-pointer place-content-center space-y-5 py-3 md:px-5 md:py-10"
